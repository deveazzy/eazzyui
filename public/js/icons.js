...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function createIconCard(name) {
    ...
    card.className =
      "icon-item flex flex-col items-center justify-center p-4 bg-white rounded-lg shadow-sm border border-gray-200 hover:shadow-md hover:border-blue-500 transition-all duration-200 cursor-pointer";
  ...
  if (stickySection && placeholder && mainContainer) {
    ...
    const observerCallback = (entries) => {
      ...
      placeholder.style.height = isSticky
        ? `${stickySection.offsetHeight}px`
        : "0px";
    ...
    console.error(
      "Elemen untuk sticky tidak ditemukan. Pastikan ID elemen sudah benar."
    );
  }
});