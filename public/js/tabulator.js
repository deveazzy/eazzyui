...
document.addEventListener('DOMContentLoaded', function() {
    var tabledata = [
        ...
        {id:7, nama:"Nurul Hidayah", umur:31, kota:"Palembang", status:false},
        ...
        columns:[ 
            ...
            {title:"Status", field:"status", width:120, hozAlign:"center", formatter:"tickCross", sorter:"boolean",
                formatterParams:{
                    ...
                    allowTruthy:true,
                    allowFalsy:true,
                    tickElement:"<i data-lucide='check-circle' class='text-green-500 w-5 h-5'></i>",
                    crossElement:"<i data-lucide='x-circle' class='text-red-500 w-5 h-5'></i>",
                }
            },
        ],
    });
