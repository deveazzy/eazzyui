...
<header class="mb-10 text-center">
    <h1 class="text-4xl font-bold text-gray-900">Template Elemen Dasar (Atoms)</h1>
    <p class="mt-2 text-lg text-gray-600">Panduan visual untuk komponen dasar Eazzy Project.</p>
</header>
...
<div class="space-y-12">
    ...
    <section id="buttons" class="pt-20 -mt-20">
        <h2 class="text-2xl font-bold text-gray-800 border-b pb-2 mb-6">1. Buttons (Tombol)</h2>
    ...
    <section id="inputs" class="pt-20 -mt-20">
        <h2 class="text-2xl font-bold text-gray-800 border-b pb-2 mb-6">2. Input Fields (Formulir)</h2>
    ...
    <section id="typography" class="pt-20 -mt-20">
        <h2 class="text-2xl font-bold text-gray-800 border-b pb-2 mb-6">3. Tipografi</h2>
    ...
    <section id="badges" class="pt-20 -mt-20">
        <h2 class="text-2xl font-bold text-gray-800 border-b pb-2 mb-6">4. Badges / Tags</h2>
    ...
    <section id="avatars" class="pt-20 -mt-20">
        <h2 class="text-2xl font-bold text-gray-800 border-b pb-2 mb-6">5. Avatars</h2>
        <div class="p-6 bg-white rounded-lg shadow-sm space-y-6">
            <div>
    ...
    <section id="alerts" class="pt-20 -mt-20">
        <h2 class="text-2xl font-bold text-gray-800 border-b pb-2 mb-6">6. Alerts</h2>
        <div class="p-6 bg-white rounded-lg shadow-sm space-y-4">
            <!-- Success Alert -->
    ...
    <section id="toggles" class="pt-20 -mt-20">
        <h2 class="text-2xl font-bold text-gray-800 border-b pb-2 mb-6">7. Toggles / Switches</h2>
        <div class="p-6 bg-white rounded-lg shadow-sm space-y-4">
    ...
    <section id="progress" class="pt-20 -mt-20">
        <h2 class="text-2xl font-bold text-gray-800 border-b pb-2 mb-6">8. Bilah Kemajuan (Progress Bars)</h2>
        <div class="p-6 bg-white rounded-lg shadow-sm space-y-6">
            <div>
