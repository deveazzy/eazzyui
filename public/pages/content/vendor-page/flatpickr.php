    ...
    <div class="bg-white p-6 md:p-8 lg:p-10 rounded-lg shadow-xl max-w-7xl mx-auto">
        ...
        <section class="mb-10 md:mb-12">
            ...
            <p class="text-gray-600 leading-relaxed text-base md:text-lg mt-4">
                Dalam proyek ini, flatpickr digunakan pada halaman <a href="./atoms#inputs" class="text-blue-600 font-semibold hover:underline">Elemen Dasar (Atoms)</a> untuk mendemonstrasikan input tanggal yang interaktif.
            </p>
            <p class="text-gray-600 leading-relaxed text-base md:text-lg mt-4">
                Kunjungi situs resmi Flatpickr untuk melihat semua fitur, demo, dan dokumentasi lengkapnya: 
                <a href="https://flatpickr.js.org/" target="_blank" rel="noopener noreferrer" class="text-blue-600 hover:underline font-semibold">Flatpickr</a>.
            </p>
        </section>
