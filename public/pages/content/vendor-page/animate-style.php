<main class="flex-1 container mx-auto p-4 md:p-8 lg:p-10">
    ...
    <div class="bg-white p-6 md:p-8 lg:p-10 rounded-lg shadow-xl max-w-7xl mx-auto">
        ...
        <section class="mb-10 md:mb-12">
            <h2 class="text-2xl md:text-3xl font-bold text-gray-700 border-b-2 border-blue-200 pb-3 mb-6">Apa itu Animate?</h2>
            <p class="text-gray-600 leading-relaxed text-base md:text-lg">
                Animate adalah pustaka CSS yang sangat populer dan mudah digunakan yang menyediakan koleksi animasi CSS siap pakai. Dengan Animate, Anda dapat menambahkan efek animasi yang menarik ke elemen HTML Anda hanya dengan menambahkan kelas CSS yang sesuai. Ini adalah solusi yang cepat dan efisien untuk membuat antarmuka pengguna Anda lebih dinamis dan interaktif tanpa perlu menulis kode JavaScript yang kompleks.
            </p>
            ...
            <p class="text-gray-600 leading-relaxed text-base md:text-lg mt-4">
                Kunjungi situs resmi Animate untuk melihat semua animasi yang tersedia dan dokumentasi lengkapnya: 
        ...
        <section class="mb-10 md:mb-12 pt-10 ">
            ...
            <p class="text-gray-600 leading-relaxed text-base md:text-lg mb-4">
                Berikut adalah langkah-langkah untuk memasang dan menggunakan Animate di proyek Anda:
            </p>
            <ol class="list-decimal list-inside space-y-6 text-gray-600 text-base md:text-lg">
                ...
                <li>
                    ...
                    <p class="mt-1">Sertakan file CSS Animate di bagian `<head>` dokumen HTML Anda. Jika Anda menggunakan bundler seperti Webpack, Anda bisa mengimpornya langsung di JavaScript utama Anda.</p>
...
element.addEventListener('animationend', () => {
  element.classList.remove('animate__bounceOut'); // Hapus kelas setelah animasi selesai
        ...
        <section class="mb-10 md:mb-12 pt-10 ">
            <h2 class="text-2xl md:text-3xl font-bold text-gray-700 border-b-2 border-blue-200 pb-3 mb-6">Manfaat Animate</h2>
            <ul class="space-y-4">
